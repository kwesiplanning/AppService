...
def typeOfApplicationPageErrorTitle = 'Error: What type of planning application is your appeal about? - Before you start - Appeal a planning decision - GOV.UK'

WebUI.openBrowser(GlobalVariable.lpaPageUrl)
...
WebUI.verifyMatch(WebUI.getWindowTitle(), typeOfApplicationPageErrorTitle, false)
